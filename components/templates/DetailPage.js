                ...
                <div className='flex flex-col justify-center text-sm sm:text-lg mx-auto p-10 gap-y-5 w-full sm:w-[70%] bg-purple-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-15'>
                    {isEditing ? (
                        <form onSubmit={handleSubmit} className='flex flex-col gap-y-4'>
                            ...
                            <button onClick={()=>setIsEditing(false)} className='rounded p-1 place-items-center bg-yellow-400 m-y-2 backdrop-filter hover:bg-yellow-500'>لغو</button>
                        ...
                        <>
                            <p className='rounded-md flex items-center gap-x-5 h-10 text-slate-100 bg-green-500'>
                                <span className='inline-block h-10 p-1 place-content-center text-center w-28 bg-green-600 text-white'>موضوع:</span> {title}
                            </p>
                            ...
                            <button onClick={editHandler} className='rounded p-1 place-items-center bg-yellow-400 m-y-2 backdrop-filter hover:bg-yellow-500'>ویرایش</button>
                        </>
                    )}
                </div>
            </div>
